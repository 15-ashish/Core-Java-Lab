/*
Program: calculating square,cube,and checking odd/even of given number using switch case
Ashish Sahay
20 oct 2022  
*/
...
class SqCubeOddEven
{
	   ...
	   static void input() //method to take input from user 
	   {
		  ...
		  calc(choice,number); //calling calc() method to calculate square,cube or check odd/even
